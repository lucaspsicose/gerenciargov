...
class Gg_prefeiturasController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Gg_prefeituras');
	...
	{
		$model=new Gg_prefeituras('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Gg_prefeituras']))
			$model->attributes=$_GET['Gg_prefeituras'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Gg_prefeituras::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gg-prefeituras-form')
		{
