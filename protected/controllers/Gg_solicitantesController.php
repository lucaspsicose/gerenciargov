...
class Gg_solicitantesController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Gg_solicitantes');
	...
	{
		$model=new Gg_solicitantes('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Gg_solicitantes']))
			$model->attributes=$_GET['Gg_solicitantes'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gg-solicitantes-form')
		{
